# Mesa Turnip for Adreno 810 (main branch)

Модифицированная сборка Mesa Turnip с улучшенной поддержкой **Adreno 810**  
(устройства на базе процессоров Snapdragon 6 Gen 4
Snapdragon 7s Gen 3
Snapdragon 7s Gen 4).

Цель проекта — улучшить стабильность и совместимость Turnip на Adreno 810,  
...
Это попытка (возможно неудачная 🙂) привести Adreno 810 в рабочее состояние.
...
| Adreno 830 | Может работать (не тестировалось) |
| Adreno 840 | Может работать (не тестировалось) |
| Adreno 829 / 825 | Не работает |
...
- Сообществу Adreno 810 — за тестирование и обратную связь  
